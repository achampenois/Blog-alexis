...
<body>
    ...
    <main>
        ...
        error_reporting(E_ALL);
         include("BDD.php");
        $requete = "SELECT Contents, FirstName, LastName, post.Id, category.Name, CreationTimestamp, Title FROM post LEFT JOIN author ON post.Author_Id =author.Id LEFT JOIN category ON post.Category_Id = category.Id ORDER BY CreationTimestamp desc"; 
